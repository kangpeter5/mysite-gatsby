...
const AboutPage = () => (
    <Layout>
        <SEO title="About" />
        <h1>About Me</h1>
        <p>I started out as a Battery Systems Test Engineer for <BodyLink href="https://www.linkedin.com/in/kangpeter">General Motors</BodyLink> writing and running automated-tests (using Visual Basics and iTest) for the Chevrolet Volt and other hybrid vehicles.</p>
